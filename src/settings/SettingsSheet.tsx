...
export function SettingsSheet({
  ...
  // Legacy callers still pass collapse props while App owns the remaining map-context sheets.
  // Settings itself now uses the shared FieldHub chrome and body scrolling exclusively.
  void collapsed;
  ...
  return (
    <FieldHub
      ...
      kicker={t(language, "personal")}
      onClose={onClose}
      initialSnap="expanded"
      className="settings-field-hub"
    >
      <div className="settings-field-hub-content">
