...
- Plan 029 bleibt aktiv, bis exakter finaler Head-CI und exakter Cloudflare-Check auf demselben SHA dokumentiert sind; das Sync-Handoff bleibt sauber und PR #74 read-only.
...
- Exakter finaler GitHub-CI-Nachweis ist grün. Der Cloudflare-Botstand zeigt noch den älteren Commit `29463cba`; deshalb bleibt Plan 029 bis zum exact-head Cloudflare-Nachweis aktiv. Reale Android-/iPhone-Abnahme bleibt separat.
