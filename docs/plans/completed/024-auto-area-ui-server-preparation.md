...
Der normale Distribution-Area-Sheet verwendet den serverautorisierten Preparation-Status. Fehlende Vorbereitung wird genau einmal gestartet, Pending wird nur bei offenem Sheet im Zwei-Sekunden-Takt gelesen und Ready löst einen normalen Snapshot-Refresh aus. Failed bietet berechtigten Rollen einen manuellen Retry, ein fehlendes 0014-Schema keinen Retry-Loop.
